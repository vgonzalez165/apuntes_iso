...
2. ](01_introducción.md)
3. [Objetos y el pipeline](02_pipelines.md)
4. [Tipos de datos y variables](03_tipos_datos_y_variables.md)
5. [Gestión de usuarios y grupos](06_usuarios.md)
6. [Gestión avanzada de usuarios y grupos](07_usuarios_avanzado.md)
7. [Conexión remota](08_conexion_remota.md)
8. [Gestión de Hyper-V desde Powershell](05_hyperv.md)
9. [Powershell y el almacenamiento](08_almacenamiento.md)
10. [El sistema de ficheros en Powershell](04_sistema_ficheros.md)
